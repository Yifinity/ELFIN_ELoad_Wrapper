...
class DataTableWidget(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.load1_voltage.grid(row=2, column=1, padx=10, pady=5, sticky="nsew")
        ...
        self.load1_setting = ctk.CTkLabel(self, text="0", text_color="white")
        ...
        self.load2_voltage.grid(row=2, column=2, padx=10, pady=5, sticky="nsew")
        ...
        self.load2_setting = ctk.CTkLabel(self, text="0", text_color="white")
        ...
        self.load3_voltage.grid(row=2, column=3, padx=10, pady=5, sticky="nsew")
        ...
        self.load3_setting = ctk.CTkLabel(self, text="0", text_color="white")
        self.load3_setting.grid(row=4, column=3, padx=10, pady=5, sticky="nsew")
